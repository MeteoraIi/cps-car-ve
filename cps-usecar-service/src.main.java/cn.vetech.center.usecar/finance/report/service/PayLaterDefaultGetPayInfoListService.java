 ...
 */
@Service
public class PayLaterDefaultGetPayInfoListService extends AbstractGetPayInfoListService {
    @Override
    ...
    public boolean canMatch(OrderEsVO orderEsVO) {
        ...
        return isPayLater(orderEsVO) && EnumSet.of(YC2M, YC2O, YC2P).contains(usecarOrderStatusEnum) && StringUtils.isBlank(orderEsVO.getBcdzt());
    }
